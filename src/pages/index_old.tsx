          ...
          <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="max-w-lg text-balance leading-relaxed">
                Transforming Meeting Audio Into Clear, Concise Summaries: Your
                Ultimate Dashboard for Translation and Insightful Analysis.
              </CardDescription>
            </CardHeader>
            <CardFooter>
          ...
          <TabsContent value="week">
            <Card x-chunk="dashboard-05-chunk-3">
              <CardHeader className="px-7">
                ...
                <CardDescription>
                  Recent conversations you have recorded
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
